...
library(STAR)
rm(list=ls())
setwd('C:/Users/User/Desktop/corona')
...
skage.groups <- stratify_by_age(skage, age_limits)
age_limits_new = c(5,10,15,20,25,30,35,40,45,50,55,60,65,70,75)
skage.groups_new <- stratify_by_age(skage, age_limits_new)
...
write.csv(seiq_matrix,'initial_seiq.csv')
