...
#age_data
japan_age = read.csv('japan_population.csv',header=T)
age_limits = c(5,10,15,20,25,30,35,40,45,50,55,60,65,70,75)

japan_age = as.numeric(japan_age$x)*1000
japan_age_group = japan_age[1:16]

#########################################################################################################################
###### Japan reports total COVID-19 cases daily and age-specific cases (10-year age interval) weekly. ###################
### In that, we obtained daily age-specific COVID-19 cases by applying weekly age demographics to daily case numbers. ###
#########################################################################################################################
